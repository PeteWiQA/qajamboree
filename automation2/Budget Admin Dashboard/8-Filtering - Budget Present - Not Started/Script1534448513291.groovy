 ...
 * Updated 08-16-2018 17:03PM by Pete Wilson
 * .split('of ')[1].replaceAll(' users', '')
 */

//Check the filter by passing the filter name and the filter object
CustomKeywords.'tools.commonCode.verifyFilterToPagination'('Budget Present - Not Started', 'ABC/Budget Admin Dashboard/Filter-Budget Present-Not Started')