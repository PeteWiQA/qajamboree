...
/* This purpose of this test is to read the By Product Category table on the Daily Sales Detail accordion
 ...
 * Updated 08-10-2018 13:21PM by Pete Wilson
 * Updated 11-14-2018 13:22PM by Pete Wilson
...
CustomKeywords.'tools.commonCode.verifyProductCategory'(GlobalVariable.userDivision,'ABC/Sales Dashboard/Daily Sales Details/table-By Product Category - Daily Totals')
...
for (int loop = 1; loop <= numberOfRows; loop++) {
    ...
    dailySales = WebUI.getText(findTestObject('ABC/Sales Dashboard/Daily Sales Details/table-By Product Category - Daily Totals', [('row') : loop, ('column') : 2]))
	
    log.logWarning('Sales Figure Amount:=' + dailySales)

    dailyGP = WebUI.getText(findTestObject('ABC/Sales Dashboard/Daily Sales Details/table-By Product Category - Daily Totals', [('row') : loop, ('column') : 3]))

    log.logWarning('Gross Profit:=' + dailyGP)

    dailyMargin = WebUI.getText(findTestObject('ABC/Sales Dashboard/Daily Sales Details/table-By Product Category - Daily Totals', [('row') : loop, ('column') : 4]))
