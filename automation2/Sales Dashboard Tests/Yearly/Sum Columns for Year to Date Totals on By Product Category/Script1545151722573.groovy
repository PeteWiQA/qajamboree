 ...
 * on the Year To Date Totals table on the Yearly Sales Detail Page - By Product Category.
...
String tableToSum="ABC/Sales Dashboard/Yearly Sales Details/By Product Category/table-Year to Date Totals"
int numberOfRows=0
...
int siteSalesTotal=WebUI.getText(findTestObject('ABC/Sales Dashboard/Yearly Sales Details/By Product Category/table-Footer Row Totals', [('column') : 2])).replaceAll("[^0-9-]","").toInteger()
int siteGPTotal=WebUI.getText(findTestObject('ABC/Sales Dashboard/Yearly Sales Details/By Product Category/table-Footer Row Totals', [('column') : 3])).replaceAll("[^0-9-]","").toInteger()
int siteSalesDifferenceTotal=WebUI.getText(findTestObject('ABC/Sales Dashboard/Yearly Sales Details/By Product Category/table-Footer Row Totals', [('column') : 4])).replaceAll("[^0-9-]","").toInteger()
int siteGPProfitTotal=WebUI.getText(findTestObject('ABC/Sales Dashboard/Yearly Sales Details/By Product Category/table-Footer Row Totals', [('column') : 5])).replaceAll("[^0-9-]","").toInteger()
int sitePlanGPTotal=WebUI.getText(findTestObject('ABC/Sales Dashboard/Yearly Sales Details/By Product Category/table-Footer Row Totals', [('column') : 6])).replaceAll("[^0-9-]","").toInteger()
int siteProfitDifferenceTotal=WebUI.getText(findTestObject('ABC/Sales Dashboard/Yearly Sales Details/By Product Category/table-Footer Row Totals', [('column') : 7])).replaceAll("[^0-9-]","").toInteger()
