 ...
 * This test is for Crop Protection (Chem) items. It confirms a result
 * is returned for Product Name, Manufacturer, Loan Type and Active.
 *
 * Created 04-08-2020 16:43PM by Pete Wilson
 */
...
WebUI.waitForElementClickable(findTestObject('Products/tab-Product',[('tabName'):'Crop Protection']), 10)
WebUI.click(findTestObject('Products/tab-Product',[('tabName'):'Crop Protection']))

//Check Product Name
searchText="Trans"
WebUI.setText(findTestObject('Products/Crop Protection/input-Product Name'), searchText)
WebUI.click(findTestObject('Products/Crop Protection/btn-Search'))
WebUI.waitForJQueryLoad(30)
confirmSearch(searchText, 1)

//Check List price
String listPrice=WebUI.getText(findTestObject('Products/Crop Protection/table-Product Results', [('row') : 1, ('column') : 4]))
if (listPrice=="" || listPrice==null){
	KeywordUtil.markFailed('ERROR: The returned search result does not have a List Price')
}
//Check Price Threshold
String priceThreshold=WebUI.getText(findTestObject('Products/Crop Protection/table-Product Results', [('row') : 1, ('column') : 5]))
...
WebUI.setText(findTestObject('Products/Crop Protection/input-Product Name'), "")

//Check Manufacturer
searchText="Dup"
WebUI.selectOptionByLabel(findTestObject('Products/Crop Protection/select-Manufacturer'), searchText, false)
WebUI.click(findTestObject('Products/Crop Protection/btn-Search'))
WebUI.waitForJQueryLoad(30)
confirmSearch(searchText, 2)
WebUI.selectOptionByLabel(findTestObject('Products/Crop Protection/select-Manufacturer'), '--Select--', false)

//Check Loan Type
searchText="DP"
WebUI.selectOptionByLabel(findTestObject('Products/Crop Protection/select-Loan Type'), searchText, false)
WebUI.click(findTestObject('Products/Crop Protection/btn-Search'))
WebUI.waitForJQueryLoad(30)
confirmSearch(searchText, 3)
WebUI.selectOptionByLabel(findTestObject('Products/Crop Protection/select-Loan Type'), '--All Loans--', false)

//Check Active
searchText="Active"
WebUI.selectOptionByLabel(findTestObject('Products/Crop Protection/select-Active'), searchText, false)
WebUI.click(findTestObject('Products/Crop Protection/btn-Search'))
WebUI.waitForJQueryLoad(30)
...
WebUI.selectOptionByLabel(findTestObject('Products/Crop Protection/select-Active'), '--All--', false)
...
def confirmSearch(String searchText, int column){
	 ...
	 */
	KeywordLogger log = new KeywordLogger()
	String searchResult=WebUI.getText(findTestObject('Products/Crop Protection/table-Product Results', [('row') : 1, ('column') : column]))
